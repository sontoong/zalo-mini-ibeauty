  ...
  return (
    <div className="mx-4 flex flex-col gap-[14px]">
      <div className="flex justify-between">
        <div className="text-xl font-medium">Cửa hàng gần bạn</div>
        <Button
          text={
            <div className="text-[15px] font-medium text-blue5">Tất cả</div>
          }
          className="flex-none"
    ...
    <div className="flex gap-[20px]">
      ...
      <div className="flex flex-1 flex-col gap-[12px] overflow-hidden">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex items-center gap-[4px] rounded-[12px] border border-stroke1 px-[8px] py-[3px]">
